...
//session and Term
        ...
        if($count == 0){ //if Record does not exsit, insert the new record
          ...
          {
              $qquery=mysqli_query($conn,"insert into tblattendance(admissionNo,classId,sessionTermId,status,dateTimeTaken) 
              value('$ros[admissionNumber]','$_SESSION[classId]','$sessionTermId','0','$dateTaken')");
