                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                      ...
                      $query = "SELECT tblattendance.Id,tblattendance.status,tblattendance.dateTimeTaken,tblclass.className,tblsessionterm.sessionName,tblsessionterm.termId,tblterm.termName,
