...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"insert into tblstudents(firstName,lastName,admissionNumber,password,classId,dateCreated) 
    value('$firstName','$lastName','$admissionNumber','12345','$classId','$dateCreated')");
